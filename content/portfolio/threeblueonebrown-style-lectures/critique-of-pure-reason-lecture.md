...
graph TD
    subgraph Mind
        A[Sensory Manifold - Raw Data] --> B(Synthesis governed by Categories);
        B --> C{Unified Experience / Nature};
        D(Unity of Consciousness - 'I think') -- Requires --> B;
    end
    subgraph World as Experienced
        C -- Exhibits --> E[Laws of Nature - Causality, Substance, etc.];
    end
    %% Style
    classDef mind fill:#f9f,stroke:#333,stroke-width:2px;
